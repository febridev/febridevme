      ...
      <div className="flex flex-col-reverse gap-6 py-10 @[480px]:gap-8 @[864px]:flex-row @[864px]:items-center">
        ...
        <div className="flex flex-col gap-6 @[480px]:gap-8 flex-1">
          <div className="flex flex-col gap-4 text-left">
            ...
            {/* Subheading */}
            <h2 className="text-slate-500 dark:text-slate-400 text-lg font-normal leading-relaxed max-w-xl">
          ...
          <div className="flex flex-wrap gap-3">
            <button className="flex min-w-[120px] cursor-pointer items-center justify-center gap-2 rounded-lg h-12 px-6 bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-base font-bold transition-transform active:scale-95 hover:shadow-lg">
              <span>View Github</span>
              <span className="material-symbols-outlined text-lg">open_in_new</span>
            </button>
            <button className="flex min-w-[120px] cursor-pointer items-center justify-center gap-2 rounded-lg h-12 px-6 bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-white text-base font-bold transition-transform active:scale-95 hover:bg-slate-300 dark:hover:bg-slate-700">
          ...
          <div className="flex gap-6 mt-4">
            ...
            <div className="h-auto w-px bg-slate-200 dark:bg-slate-700"></div>
            <div className="flex flex-col">
              <span className="text-2xl font-bold text-slate-900 dark:text-white">5k+</span>
              <span className="text-sm text-slate-500 dark:text-slate-400">Contributions</span>
            </div>
            <div className="h-auto w-px bg-slate-200 dark:bg-slate-700"></div>
            <div className="flex flex-col">
